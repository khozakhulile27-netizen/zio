...
// msgLogger: ZLogger[String, Unit] = zio.ZLogger$$anon$6@732c754d

// 2. Adapt it to accept integers as messages
val intLogger: ZLogger[Int, Unit] =
  msgLogger.contramap[Int](_.toString)
// intLogger: ZLogger[Int, Unit] = zio.ZLogger$$anon$2@a93eae2
...
// warnLogger: ZLogger[String, Option[Unit]] = zio.ZLogger$$anon$3@3a29156b
...
// sampleLine: String = "timestamp=2026-07-16T14:44:41.833643306Z level=INFO thread=#zio-fiber- message=\"something happened\""

// 5. Fan both loggers together; Zippable[String, Unit].Out = String
val combined: ZLogger[String, String] = ZLogger.default ++ msgLogger
// combined: ZLogger[String, String] = zio.ZLogger$$anon$1@4c869d06
```
